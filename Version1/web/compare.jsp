            ...
            <div class="col-lg-12">
                <div class="page-breadcrumb">
                    <ul class="nav">
                        ...
                        <li><a href="shop.jsp" class="active">对比</a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <table class="table table-bordered mb-0">
                            ...
                            <tr>
                                ...
                                <td class="product-image-title">
                                    ...
                                    <a href="single-product-sale.html" class="title">Zeon Zen 4 Pro</a>
                                </td>
                                <td class="product-image-title">
                                    <a href="single-product.html" class="image"><img class="img-fluid"
                                    ...
                                    <a href="single-product-group.html" class="title">Aquet Doren D 420</a>
                                </td>
                                <td class="product-image-title">
                                    <a href="single-product.html" class="image"><img class="img-fluid"
